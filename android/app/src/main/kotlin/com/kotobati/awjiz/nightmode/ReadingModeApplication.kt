...
class ReadingModeApplication : Application() {
    ...
    private fun upgradeProfilesFrom(version: Int) {
        ...
        val PREFERENCE_NAME = "com.kotobati.awjiz.PROFILES_PREFERENCE"
    ...
    companion object : Logger() {
        lateinit var app: ReadingModeApplication
            private set
    }
}
