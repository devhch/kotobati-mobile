...
import com.kotobati.awjiz.nightmode.ProfilesModel.Log
import com.kotobati.awjiz.nightmode.appContext
import com.kotobati.awjiz.nightmode.helper.Logger
import com.kotobati.awjiz.nightmode.service.LocationUpdateService
    ...
    companion object : Logger() {
        ...
        private fun scheduleNextCommand(turnOn: Boolean) {
            if (Config.scheduleOn) {
                ...
                Log.i("Scheduling alarm for $calendar")
