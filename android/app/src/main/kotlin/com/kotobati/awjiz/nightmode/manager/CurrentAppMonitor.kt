...
import com.kotobati.awjiz.nightmode.App
import com.kotobati.awjiz.nightmode.Command
import com.kotobati.awjiz.nightmode.CurrentAppChecker
import com.kotobati.awjiz.nightmode.atLeastAPI
import com.kotobati.awjiz.nightmode.helper.Logger
import com.kotobati.awjiz.nightmode.receiver.ScreenStateReceiver
...
class CurrentAppMonitor(
    ...
    var monitoring: Boolean by Delegates.observable(false) { _, isOn, turnOn ->
        when {
    ...
    private var active: Boolean by Delegates.observable(false) { _, isOn, turnOn ->
        when {
